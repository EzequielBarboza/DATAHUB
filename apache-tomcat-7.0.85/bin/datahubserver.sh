...
# * Set the minimum memory to 8192mb
# * Set the maximum memory to 8192mb
...
export CATALINA_OPTS="-Xms8192m -Xmx8192m -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+AlwaysPreTouch -XX:+DisableExplicitGC"
